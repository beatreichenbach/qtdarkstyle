...
def apply_style(app: QtWidgets.QApplication = None) -> None:
    ...
    palette.setColor(QtGui.QPalette.Midlight, meidum3)
    ...
    palette.setColor(QtGui.QPalette.Window, palette.color(QtGui.QPalette.AlternateBase))
    app.setPalette(palette, QtWidgets.QScrollArea.__name__)
